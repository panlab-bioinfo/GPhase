...
def parse_arguments() -> argparse.Namespace:
    ...
    graph_group.add_argument("-s", "--group_ctgs_file",metavar='\b', required=True, help="Subgraph resulting from the GFA split")
    ...
    genome_group.add_argument("-nc", "--n_chr", metavar='\b', required=True,type=int, help="Number of chromosomes")
    genome_group.add_argument("-nh", "--n_hap", metavar='\b', required=True,type=int, help="Number of haplotypes")
    ...
    performance_group .add_argument("-t", "--threads", metavar='\b', type=int, default=1, help="Number of parallel processes")
